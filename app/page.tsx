    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-white px-6 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-slate-900 hidden sm:inline-block">EduBridge AI</span>
        </div>
        ...
        <section className="relative overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              EduBridge AI Learning Platform uses advanced algorithms to identify learning gaps, personalize lessons, and make quality education accessible—even in low-connectivity environments.
            </p>
        ...
        <section id="pricing" className="bg-slate-50 py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                Unlock the full power of EduBridge AI for unlimited quizzes, 24/7 tutoring, and personalized learning paths.
              </p>
            </div>
            <div className="isolate mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 md:mx-0 md:max-w-none md:grid-cols-3 lg:gap-8">
              {/* Plan 1 */}
              <div className="rounded-3xl p-6 ring-1 ring-slate-200 bg-white shadow-sm flex flex-col md:p-8 transition-all hover:shadow-md">
                <div className="flex items-center justify-between gap-x-4">
                  <h3 className="text-lg font-semibold leading-8 text-slate-900">1 Month</h3>
                </div>
                <p className="mt-4 text-sm leading-6 text-slate-600">Perfect for trying out EduBridge Pro.</p>
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span className="text-4xl font-bold tracking-tight text-slate-900">₹199</span>
                  <span className="text-sm font-semibold leading-6 text-slate-600">/month</span>
                </p>
                <Link href="/register" className="mt-6 block rounded-md bg-indigo-50 px-3 py-2.5 text-center text-sm font-semibold leading-6 text-indigo-600 hover:bg-indigo-100 ring-1 ring-inset ring-indigo-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors">
                  Get Started
                </Link>
                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-slate-600">
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> Unlimited AI generated quizzes</li>
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> 24/7 Multilingual AI Tutor</li>
                </ul>
              </div>

              {/* Plan 2 */}
              <div className="rounded-3xl p-6 ring-2 ring-indigo-600 bg-white shadow-xl flex flex-col relative md:p-8 scale-100 md:scale-105 z-10">
                <div className="flex items-center justify-between gap-x-4">
                  <h3 className="text-lg font-semibold leading-8 text-indigo-600">3 Months</h3>
                  <p className="rounded-full bg-indigo-100 px-2.5 py-1 text-xs font-semibold leading-5 text-indigo-600">Most popular</p>
                </div>
                <p className="mt-4 text-sm leading-6 text-slate-600">Best value for a complete semester.</p>
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span className="text-4xl font-bold tracking-tight text-slate-900">₹299</span>
                  <span className="text-sm font-semibold leading-6 text-slate-600">for 3 months</span>
                </p>
                <Link href="/register" className="mt-6 block rounded-md bg-indigo-600 px-3 py-2.5 text-center text-sm font-semibold leading-6 text-white hover:bg-indigo-500 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors">
                  Get Started
                </Link>
                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-slate-600">
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> All 1 Month features</li>
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> Personalized Weak-Concept Analysis</li>
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> Priority support</li>
                </ul>
              </div>
              ...
              <div className="rounded-3xl p-6 ring-1 ring-slate-200 bg-white shadow-sm flex flex-col md:p-8 transition-all hover:shadow-md">
                <div className="flex items-center justify-between gap-x-4">
                  <h3 className="text-lg font-semibold leading-8 text-slate-900">6 Months</h3>
                </div>
                <p className="mt-4 text-sm leading-6 text-slate-600">Long-term commitment for serious learners.</p>
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span className="text-4xl font-bold tracking-tight text-slate-900">₹499</span>
                  <span className="text-sm font-semibold leading-6 text-slate-600">for 6 months</span>
                </p>
                <Link href="/register" className="mt-6 block rounded-md bg-indigo-50 px-3 py-2.5 text-center text-sm font-semibold leading-6 text-indigo-600 hover:bg-indigo-100 ring-1 ring-inset ring-indigo-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors">
                  Get Started
                </Link>
                <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-slate-600">
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> All 3 Months features</li>
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> Offline-first mobile access</li>
                  <li className="flex gap-x-3"><CheckCircle2 className="h-6 w-5 flex-none text-indigo-600" /> Custom study planner</li>
                </ul>
              </div>
            </div>
          </div>
